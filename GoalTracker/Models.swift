...
struct AppSettings: Codable {
    ...
    var categories: [CategoryItem] = [
        CategoryItem(id: "action", name: String(localized: "行動習慣"), colorName: "blue"),
        CategoryItem(id: "lifestyle", name: String(localized: "生活習慣"), colorName: "yellow"),
        CategoryItem(id: "none", name: String(localized: "指定なし"), colorName: "gray")
    ]
